...
import {getVeiculo, createVeiculo, deleteVeiculo, updateVeiculo, getVeiculoByProprietario} from "../controllers/veiculo_controller.js" // , getVeiculoByTipo
...
router.get('/veiculo/:proprietario', getVeiculoByProprietario)
// router.get('/veiculo/:tipo', getVeiculoByTipo)
